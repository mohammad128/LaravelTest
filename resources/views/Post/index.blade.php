        ...
        <form id="_form" method="POST" action="" class="row justify-content-center">
            ...
            <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{ route('Post.show', [$post->id]) }}">
                                    ...
                                    <a target="_blank" href="{{ route('Post.edit', [$post->id]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <a href="{{ route('Post.delete', [$post->id, 'redirect'=>route('Post.index')]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <select name="action" id="_action" class="form-select form-select-lg mb-3"
                    ...
                    <option value="sendToDraft" data-action="{{ route('Post.sendToDraft') }}">Send To Draft</option>
                </select>
                <script>
