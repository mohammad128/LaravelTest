        ...
        <form id="_form" method="POST" action="" class="row justify-content-center">
            ...
            <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        @foreach ($videos as $video)
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{ route('Video.show', [$video->id]) }}">
                                    ...
                                    <a target="_blank" href="{{ route('Video.edit', [$video->id]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <a href="{{ route('Video.delete', [$video->id, 'redirect'=>route('Video.index')]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <select name="action" id="_action" class="form-select form-select-lg mb-3"
                    ...
                    <option value="delete" data-action="{{ route('Video.multiDelete') }}">Delete</option>
                    <option value="sendToDraft" data-action="{{ route('Video.sendToPublish') }}">Send To Published</option>
                </select>
                <script>
